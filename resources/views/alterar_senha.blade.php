        ...
        <section class="auth-card">
            ...
            <div class="input-group">
                ...
                <div class="input-wrap">
                    <input type="password" id="senha_nova" name="senha_nova" placeholder="Mínimo 6 caracteres"/>
                    <i class="fa-solid fa-eye toggle-senha" id="toggleSenha"></i>
                </div>
            </div>

            <button id="confirmar_senha" class="btn-submit">Alterar Senha</button>

            <p class="auth-footer">
                Certifique-se de que sua nova senha seja segura e fácil de lembrar.
            </p>
        </section>
    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.erro === 'n') {
                            ...
                            alert(response.data || 'Erro ao alterar senha.');
                        }
                    },
                    error: function(xhr) {
                        const response = xhr.responseJSON;
                        alert((response && response.data) ? response.data : 'Erro ao alterar senha.');
                    }
                });
            });

            $('#senha_nova').on('keydown', function(e) {
                if (e.key === 'Enter') {
